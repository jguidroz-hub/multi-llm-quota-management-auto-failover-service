...
const FROM = process.env.EMAIL_FROM || 'Multi-LLM Quota Management & Auto-Failover Service <noreply@example.com>';
const APP_NAME = 'Multi-LLM Quota Management & Auto-Failover Service';
